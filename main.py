...
# )
#
# # saving the pairplot as and image because i don't have an intercative canvas
# plt.savefig("taxi_fare_pairplot.png")  # You can choose .jpg, .pdf, etc.
# plt.show()  # This line will still
